const translations = {
  en: {
    ...
    introBody: "Your Chinese name is not just a label. It is a code woven from sound, form, and meaning. We decode the five elemental forces within your birth time and identity to reveal who you truly are.",
    atlasEyebrow: "ZODIAC ARCHETYPES · ELEMENTAL CODE",
    atlasTitle: "The 12 Archetypes of Your Elemental Code",
  ...
  zh: {
    navPlans: "服务与交付", navNaming: "起名", navCulture: "生肖文化", navCraft: "东方好物", accountLinkGuest: "注册 / 登录", eyebrow: "源自古老东方五行智慧",
    ...
    atlasEyebrow: "生肖原型 · ELEMENTAL ARCHETYPES",
    atlasTitle: "你元素代码中的12种原型",
