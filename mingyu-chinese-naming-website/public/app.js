const translations = {
  en: {
    ...
    eyebrow: "Words become a vessel · Meet the East", heroA: "Ancient Chinese Five-Elements", heroB: "Personality Profile",
    ...
    sampleTitle: "Preview a sample Five-Elements folio before you pay",
    sampleBody: "This page should not stay abstract. We show a real preview of the full PDF style and delivery format so buyers know what they receive before payment.",
    samplePreviewTitle: "Sample preview of the Five-Elements folio PDF",
    samplePreviewBody: "After payment, the full edition is organized as a saveable A4 PDF that includes zodiac culture, five-elements timing, name meanings, and polished page layout.",
    sampleCard1Eyebrow: "WHAT YOU RECEIVE",
    sampleCard1Title: "What arrives after payment",
    sampleCard1Point1: "Full result page plus downloadable PDF",
    sampleCard1Point2: "View immediately on-site and reopen it later",
    sampleCard1Point3: "Email recovery and follow-up support included",
    sampleCard2Eyebrow: "FULL EDITION PAGES",
    sampleCard2Title: "What the full edition usually includes",
    sampleCard2Point1: "Five-elements personality and trait interpretation",
    sampleCard2Point2: "Zodiac symbolism, stems, branches, elements, and birth-hour reading",
    sampleCard2Point3: "Suggested Chinese names, pinyin, meanings, and cultural notes",
    sampleCard3Eyebrow: "DELIVERY FORMAT",
    sampleCard3Title: "Why buyers feel safer before paying",
    sampleCard3Point1: "They can review a sample before choosing the full edition",
    sampleCard3Point2: "They know the PDF is a finished designed report, not an empty export",
    sampleCard3Point3: "They know the result can be saved, downloaded, and reopened later",
  ...
  zh: {
    ...
    heroA: "古老东方五行 ·", heroB: "人格特质解析", heroBody: "从你的原名、出生时刻与个性出发，获得由 AI 驱动的中文起名建议、文化解读，以及面向注册会员的付费起名报告服务。",
    begin: "开始寻名", introTitle: "不是翻译名字，而是重新认识你。",
    introBody: "中文名字是声音、字形与意义的共同选择。我们以你的身份为起点，参考生肖的文化意象与汉字传统，提供有出处、有解释、可被真实使用的名字。",
    sampleTitle: "先看一份《东方五行卷》样例",
    sampleBody: "页面不只讲概念。这里直接展示完整版 PDF 的排版风格与交付内容，让用户在付款前知道自己会得到什么。",
    samplePreviewTitle: "《东方五行卷》PDF 样例预览",
    samplePreviewBody: "你付款后拿到的完整版会整理成可保存的 A4 PDF，包含生肖文化、五行时序、名字释义与成品排版。",
    sampleCard1Eyebrow: "付款后你会拿到什么",
    sampleCard1Title: "付款后会得到什么",
    sampleCard1Point1: "完整结果页 + 可保存 PDF",
    sampleCard1Point2: "站内立即查看，并可稍后重新打开",
    sampleCard1Point3: "支持邮件找回与后续客服协助",
    sampleCard2Eyebrow: "完整版通常包含",
    sampleCard2Title: "完整版通常包含这些版块",
    sampleCard2Point1: "五行人格与性格特质解析",
    sampleCard2Point2: "生肖象征寓意、干支五行与出生时辰",
    sampleCard2Point3: "候选中文名、拼音、释义与文化说明",
    sampleCard3Eyebrow: "为什么更容易下单",
    sampleCard3Title: "用户为什么更容易放心付款",
    sampleCard3Point1: "先看到样例，再决定是否购买完整版",
    sampleCard3Point2: "清楚知道 PDF 不是空白页，而是完整排版成品",
    sampleCard3Point3: "知道付款后能保存、下载、找回，不怕丢结果",
